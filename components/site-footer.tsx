  ...
  return (
    <footer className="site-footer">
      <div className="container footer-grid">
        ...
        <div><h3>Legal</h3><Link href="/responsible-gaming">Responsible Use</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/business-terms">Business Terms</Link><Link href="/refund-policy">Refund Policy</Link></div>
      </div>
    </footer>
  );
}
