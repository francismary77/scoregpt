...
export const predictions: Prediction[] = [
  { id:"pred-ars-che",fixtureId:"ars-che-demo",market:{id:"double-home",label:"Home win or draw",outcome:"double-chance"},confidence:confidenceScore(78),risk:"medium",status:"pending",reasoning:reasoning("The home side carries the stronger balanced profile, but transition risk remains.",["Stronger recent home form","More consistent defensive shape","Away threat prevents a low-risk rating"],["Home form","Defensive consistency","Transition exposure"]),generatedAt:"2026-08-07T08:00:00Z",source,accessLevel:"public" },
  { id:"pred-int-ata",fixtureId:"int-ata-demo",market:{id:"over-15",label:"Over 1.5 goals",outcome:"over"},confidence:confidenceScore(84),risk:"low",status:"pending",reasoning:reasoning("Both attacking profiles support at least two total goals.",["Strong chance creation","Reliable home scoring","Open recent meetings"],["Goals trend","Shot volume","Head-to-head"]),generatedAt:"2026-08-07T08:00:00Z",source,accessLevel:"registered" },
