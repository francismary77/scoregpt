...
import { MockAIIntelligenceProvider } from "./mock-ai-provider";
...
export const intelligenceService = new IntelligenceService(fixtureService,competitionService,forms,statistics,new MockAIIntelligenceProvider());
