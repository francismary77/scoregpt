...
export interface IntelligenceReportSummary { id: string; fixture: FixtureSummary; headline: string; excerpt: string | null; confidence: number | null; riskLevel: string | null; recommendedMarket: string | null; accessLevel: ContentAccessLevel; published: boolean; provenance: DataProvenance }
