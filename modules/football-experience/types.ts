...
export interface ResultSummary { fixture: FixtureSummary; date: string; status: string; provenance: DataProvenance; prediction: string; market: "MATCH_OUTCOME_1X2"; settlementStatus: "PENDING"|"SETTLED"|"VOID"|"CANCELLED"|"POSTPONED"|"ABANDONED"|"UNKNOWN_FINAL_STATE"; predictionCorrect: boolean|null }
export interface IntelligenceReportSummary { id: string; fixture: FixtureSummary; headline: string; excerpt: string | null; confidence: number | null; riskLevel: string | null; recommendedMarket: string | null; analysis: Json | null; confidenceExplanation?: string; riskExplanation?: string; accessLevel: ContentAccessLevel; published: boolean; forwardPrediction: boolean; provenance: DataProvenance }
