...
export interface UserSession{id:string;userId:string;createdAt:string;mode:"mock"}
export type AuthState={status:"checking"}|{status:"guest"}|{status:"authenticated";user:User;session:UserSession};
