...
export const businessPackages = [
  {
    ...
    whatsappMessage: "Hello FABRO TECH LIMITED, I am interested in the 9ja Football AI Launch Edition. I have a few questions before proceeding.",
    attribution: true,
    features: [
      ...
      "Free member access tier",
      "One paid subscriber tier",
      "Results tracking",
  ...
  },
  {
    ...
    features: [
      ...
      "Free member access tier plus two paid subscriber tiers",
      "A second paid tier for additional monetisation flexibility",
    ...
    capabilityNote: "Business modules and coverage for up to 30 top football leagues and competitions are configured for each customer. Coverage expands as competitions and provider services are enabled for the agreed platform.",
  },
] as const;
